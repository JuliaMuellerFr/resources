...
## Who am I?
- working on PhD in English linguistics (re: the interaction between a person's first and second language and how the former affects the latter during language processing)  
...
- show features on these slides ("Welcome to Quarto")  
- invite you to try them by working on the file "Quarto demonstration - START HERE"  

### What you can (and can't) expect
- thorough overview of the main features  
- lots of features for html documents (many of which transfer to Word and pdf)  
- ...and for html slides  
